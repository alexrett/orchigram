...
.PHONY: tools release-tools generate generate-check fmt vet test race lint buf-check actions-pinned release-workflow secret-scan history-scan dependency-licenses plugin-sboms build cross-build check release-check clean
...
check: generate-check fmt vet test race lint buf-check actions-pinned release-workflow secret-scan build
