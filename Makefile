...
.PHONY: tools generate generate-check fmt vet test race lint buf-check secret-scan build cross-build check release-check clean
...
release-check: check cross-build
